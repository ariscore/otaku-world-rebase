...
class ActivityMentionNotificationCard extends StatelessWidget {
  const ActivityMentionNotificationCard({super.key, required this.notification});

  final Fragment$ActivityMentionNotification notification;
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: notification.context ?? ' mentioned you in their activity.',
                  ),
                ],
              ),
            ),
