...
class ThreadCommentLikeNotificationCard extends StatelessWidget {
  const ThreadCommentLikeNotificationCard({super.key, required this.notification});

  final Fragment$ThreadCommentLikeNotification notification;
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: notification.context ?? ' liked your forum comment',
                  ),
                ],
              ),
            ),
