...
class MediaDataChangeNotificationCard extends StatelessWidget {
  const MediaDataChangeNotificationCard({super.key, required this.notification});

  final Fragment$MediaDataChangeNotification notification;
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: notification.context ?? ' data has been changed',
                  ),
                ],
              ),
            ),
