...
class ThreadCommentMentionNotificationCard extends StatelessWidget {
  const ThreadCommentMentionNotificationCard({
    super.key,
    required this.notification,
  });

  final Fragment$ThreadCommentMentionNotification notification;
                ...
                children: [
                  ...
                  TextSpan(
                    text: notification.context ??
                        ' mentioned you in a forum comment',
                  ),
                ],
              ),
            ),
