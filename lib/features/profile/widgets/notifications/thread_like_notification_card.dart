...
class ThreadLikeNotificationCard extends StatelessWidget {
  const ThreadLikeNotificationCard({super.key, required this.notification});

  final Fragment$ThreadLikeNotification notification;
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: notification.context ?? ' liked your forum thread',
                  ),
                ],
              ),
            ),
