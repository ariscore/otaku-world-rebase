...
class FollowingNotificationCard extends StatelessWidget {
  const FollowingNotificationCard({super.key, required this.notification});

  final Fragment$FollowingNotification notification;
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: notification.context ?? ' started following you.',
                  ),
                ],
              ),
            ),
