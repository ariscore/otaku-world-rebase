...
class ActivityReplySubscribedNotificationCard extends StatelessWidget {
  const ActivityReplySubscribedNotificationCard({
    super.key,
    required this.notification,
  });

  final Fragment$ActivityReplySubscribedNotification notification;
                ...
                children: [
                  ...
                  TextSpan(
                    text: notification.context ??
                        ' replied to activity you\'re subscribed to',
                  ),
                ],
              ),
            ),
