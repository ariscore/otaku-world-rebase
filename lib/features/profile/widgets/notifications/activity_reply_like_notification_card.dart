...
class ActivityReplyLikeNotificationCard extends StatelessWidget {
  const ActivityReplyLikeNotificationCard({super.key, required this.notification});

  final Fragment$ActivityReplyLikeNotification notification;
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: notification.context ?? ' liked your activity reply.',
                  ),
                ],
              ),
            ),
