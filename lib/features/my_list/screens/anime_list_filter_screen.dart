...
class AnimeListFilterScreen extends StatefulWidget {
  const AnimeListFilterScreen({super.key, required this.listBloc});

  final MediaListBloc listBloc;

  @override
  State<AnimeListFilterScreen> createState() => _AnimeListFilterScreenState();
}

class _AnimeListFilterScreenState extends State<AnimeListFilterScreen> {
  ...
  @override
  void initState() {
    filter = widget.listBloc.filter as AnimeFilter;
