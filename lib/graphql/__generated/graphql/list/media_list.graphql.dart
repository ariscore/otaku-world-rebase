...
class Query$MediaList$MediaListCollection$user$mediaListOptions {
  ...
  factory Query$MediaList$MediaListCollection$user$mediaListOptions.fromJson(
    ...
    return Query$MediaList$MediaListCollection$user$mediaListOptions(
      ...
      animeList: l$animeList == null
          ? null
          : Query$MediaList$MediaListCollection$user$mediaListOptions$animeList
              .fromJson((l$animeList as Map<String, dynamic>)),
      mangaList: l$mangaList == null
          ? null
          : Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList
              .fromJson((l$mangaList as Map<String, dynamic>)),
      $__typename: (l$$__typename as String),
    );
  }
  ...
  final Query$MediaList$MediaListCollection$user$mediaListOptions$animeList?
      animeList;

  final Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList?
      mangaList;
...
abstract class CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions<
  ...
  CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList<
      TRes> get animeList;
  CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList<
      TRes> get mangaList;
}
    ...
    Object? $__typename = _undefined,
      ...
      _then(Query$MediaList$MediaListCollection$user$mediaListOptions(
        ...
        animeList: animeList == _undefined
            ? _instance.animeList
            : (animeList
                as Query$MediaList$MediaListCollection$user$mediaListOptions$animeList?),
        mangaList: mangaList == _undefined
            ? _instance.mangaList
            : (mangaList
                as Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList?),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
...
class Query$MediaList$MediaListCollection$user$mediaListOptions$animeList {
  Query$MediaList$MediaListCollection$user$mediaListOptions$animeList({
    this.sectionOrder,
    this.customLists,
  ...
  factory Query$MediaList$MediaListCollection$user$mediaListOptions$animeList.fromJson(
      Map<String, dynamic> json) {
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Query$MediaList$MediaListCollection$user$mediaListOptions$animeList ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$sectionOrder = sectionOrder;
...
extension UtilityExtension$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList
    on Query$MediaList$MediaListCollection$user$mediaListOptions$animeList {
  CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList<
          Query$MediaList$MediaListCollection$user$mediaListOptions$animeList>
      get copyWith =>
          CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList(
...
abstract class CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList<
    TRes> {
  factory CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList(
    Query$MediaList$MediaListCollection$user$mediaListOptions$animeList
        instance,
    TRes Function(
            Query$MediaList$MediaListCollection$user$mediaListOptions$animeList)
        then,
  ) = _CopyWithImpl$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList;

  factory CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList.stub(
          TRes res) =
      _CopyWithStubImpl$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList;
...
class _CopyWithImpl$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList<
        TRes>
    implements
        CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList<
            TRes> {
...
class _CopyWithStubImpl$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList<
        TRes>
    implements
        CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$animeList<
            TRes> {
...
class Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList {
  Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList({
    this.sectionOrder,
    this.customLists,
    this.splitCompletedSectionByFormat,
  ...
  factory Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList.fromJson(
      Map<String, dynamic> json) {
    final l$sectionOrder = json['sectionOrder'];
    final l$customLists = json['customLists'];
    final l$splitCompletedSectionByFormat =
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$sectionOrder = sectionOrder;
...
extension UtilityExtension$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList
    on Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList {
  CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList<
          Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList>
      get copyWith =>
          CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList(
...
abstract class CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList<
    TRes> {
  factory CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList(
    Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList
        instance,
    TRes Function(
            Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList)
        then,
  ) = _CopyWithImpl$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList;

  factory CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList.stub(
          TRes res) =
      _CopyWithStubImpl$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList;
...
class _CopyWithImpl$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList<
        TRes>
    implements
        CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList<
            TRes> {
...
class _CopyWithStubImpl$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList<
        TRes>
    implements
        CopyWith$Query$MediaList$MediaListCollection$user$mediaListOptions$mangaList<
            TRes> {
