...
class Options$Query$MediaEntry extends graphql.QueryOptions<Query$MediaEntry> {
  Options$Query$MediaEntry({
    ...
    Query$MediaEntry? typedOptimisticResult,
...
class WatchOptions$Query$MediaEntry
    extends graphql.WatchQueryOptions<Query$MediaEntry> {
  WatchOptions$Query$MediaEntry({
    String? operationName,
    Variables$Query$MediaEntry? variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
class FetchMoreOptions$Query$MediaEntry extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$MediaEntry({
...
extension ClientExtension$Query$MediaEntry on graphql.GraphQLClient {
  ...
  void writeQuery$MediaEntry({
    ...
    bool broadcast = true,
      ...
      this.writeQuery(
        graphql.Request(
          operation: graphql.Operation(document: documentNodeQueryMediaEntry),
  ...
  Query$MediaEntry? readQuery$MediaEntry({
    ...
    return result == null ? null : Query$MediaEntry.fromJson(result);
  }
}
